...
//   return (
//     <header className="bg-white shadow-sm sticky top-0 z-50">
//       <div className="mx-auto px-6 container-max flex items-center justify-between h-16">
//         <div className="flex items-center gap-3">
//           <div className="w-10 h-10 rounded-md bg-brand-500 flex items-center justify-center text-white font-bold">IE</div>
//           <div>
//             <div className="text-lg font-semibold">IELTS Institute</div>
//             <div className="text-xs text-gray-500 -mt-1">Get your target band</div>
//           </div>
//         </div>
...
//           <a href="#testimonials" className="hover:text-brand-700">Testimonials</a>
//           <a href="#contact" className="hover:text-brand-700">Contact</a>
//           <button className="ml-2 px-4 py-2 bg-brand-500 text-white rounded-md shadow-sm hover:brightness-90">Book Demo</button>
//         </nav>


//         <div className="md:hidden">
//           <button onClick={() => setOpen(!open)} aria-label="menu" className="p-2">
//             <svg width="24" height="24" viewBox="0 0 24 24" fill="none"><path d="M4 6h16M4 12h16M4 18h16" stroke="#1f2937" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" /></svg>
//           </button>
//         </div>
//       </div>
...
//             <button className="mt-2 px-4 py-2 bg-brand-500 text-white rounded-md">Book Demo</button>
//           </div>
//         </div>
//       )}
//     </header>
